...
public class QuestionController : MonoBehaviour
{
    ...
    void Right(){
        switch(t1){
            case 1:
                eventSystem.SetSelectedGameObject(s);
                t1+=1;
                break;
            case 2:
                eventSystem.SetSelectedGameObject(t);
                t1+=1;
                break;
            case 3:
                eventSystem.SetSelectedGameObject(fo);
                t1+=1;
                break;
            case 4:
                break;
    ...
    void Left(){
        switch(t1){
            case 1:
                break;
            case 2:
                eventSystem.SetSelectedGameObject(f);
                t1-=1;
                break;
            case 3:
                eventSystem.SetSelectedGameObject(s);
    ...
    public void Start()
    {
        ...
        SaveButton.onClick.AddListener(()=>{Cancel();t1-=1;Left();});
        GameButton.onClick.AddListener(()=>{Cancel();t1+=1;Right();});
        SaveButton.onClick.AddListener(()=>{menuAudio.Play();Apply();_SavedSettings.Save(filePath);});
